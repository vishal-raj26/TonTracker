...
const CATEGORY_TERMS = Object.freeze({
  ...
  technology: ["technology", "software", "digital", "cyber", "security", "exploit", "hacker", "hack", "pwned", "cloud", "data", "robot", "agent", "labs", "lab", "tech", "app", "bot", "ai"],
  media: ["avatar", "movie", "cinema", "anime", "manga", "shinigami", "sharingan", "video", "music", "media", "news", "game", "gaming", "meme"],
  ...
  aspirational: ["conviction", "freedom", "liberty", "justice", "courage", "wisdom", "victory", "loyalty", "future", "power", "trust", "truth", "glory", "faith", "hope", "destiny", "legacy"],
