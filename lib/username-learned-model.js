...
function trainUsernameLearnedModel(events = [], options = {}) {
  ...
  return {
    version: "username-learned-ridge-v2",
...
function predictUsernameLearnedModel(model, input) {
  if (!model || !["username-learned-ridge-v1", "username-learned-ridge-v2"].includes(model.version) || !Array.isArray(model.coefficients)) return null;
