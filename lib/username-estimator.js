...
function similarity(target, candidate) {
  ...
  return clamp(score + clamp(Number(candidate.semanticSimilarity || 0), 0, 1) * 0.18, 0, 1);
}
...
module.exports = { estimateTelegramUsernameValue, completedSale, similarity, weightedQuantile };
