...
function createUsernameRuntime(options = {}) {
  ...
  const firstImportEvidenceLimit = Math.max(0, Math.min(24, number(options.firstImportEvidenceLimit) || number(process.env.USERNAME_FIRST_IMPORT_EVIDENCE_LIMIT) || 12));
