...
// v17 anchors an estimate to the latest exact historical-USD sale after
// measured segment movement, then allows learned quality signals to scale up.
const USERNAME_ESTIMATOR_VERSION = "username-market-v17";
